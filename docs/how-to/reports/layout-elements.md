...
While in Customize mode, select the **gear (⚙)** on the divider to change it:
...
## Which filters affect them

**None.** The Date range, County, and Church filters change what your metrics count, but text blocks and dividers don't read any data, so the filters leave them untouched. They also don't appear in the CSV export (there's no data to export), but they do show up in the printed and PDF versions of your report.
