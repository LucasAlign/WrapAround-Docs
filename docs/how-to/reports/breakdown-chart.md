...
!!! tip "One chart, many views"
    Add the Breakdown chart several times to build a row of comparisons — for example, families by county as horizontal bars next to the status mix as a donut. Give each copy the grouping and chart type that best answers its question.

!!! note "Replaces the older charts"
    This single configurable chart takes the place of the previous separate Families by County, Families by Church, Care Community Status, and Training Completion by Church charts. Reports you already saved keep working and look the same — each old chart now appears as a ready-made version of this one.

## Related

- [Build a Reports & Impact report](../admin/reports-and-impact.md)
- [Trend chart](trend-chart.md)
